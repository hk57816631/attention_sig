...
if __name__ == '__main__':
    #genfilelist("./ImgData/TrainAugT", "train.txt")        # LabelAugT
    #genfilelist("./ImgData/TrainAugF", "train.txt")        #LAbelAugF
    #genfilelist("./ImgData/TesrT", "val.txt")              #ResultT
    #genfilelist("./ImgData/TesrF", "val.txt")              #ResultF

#   Generate image file list
#   genfilelist("../../BUS/VOC2012/wavelet", "BUSVOC_train.txt")

#   add VOC2012 palette to orginal label file
    pal =VOCPalette(nb_class=5)
    pal.genlabelfilepal("../../BUS/VOC2012/GT_tumor",False)

    #label_to_categorical("E:/hjh/医学图像样本/fcnfeature/GT", 3)